...
export default function Header() {
  ...
  return (
    <header className="h-14 flex items-center justify-between px-4 shrink-0">
      ...
      <div className="flex items-center gap-2">
        <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-border-secondary text-sm text-foreground hover:bg-secondary transition-colors">
